...
class Machine extends MY_Controller
{
    ...
    function create(){
        ...
        $data['vSatuan'] = set_value('vSatuan'); 
    ...
    function create_action(){
        ...
        $vSatuan  = $this->input->post('vSatuan',TRUE);
        ...
        if ($dCek >0) {
            ...
            $this->after_insert_process($last_id,$iJenis_proses);
    ...
    function after_insert_process($last_id,$jen){
        ...
        if($dCek['cMachineCode'] == ""){
            if($jen==2){
                $nomor = "A".str_pad($last_id, 5, "0", STR_PAD_LEFT);
            }else{
